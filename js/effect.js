...
$('document').ready(function(){
	...
	$('#invite_friends').click(function(){
		...
		$('#f1').animate({top:mid-mid_diff*4,left:vw-vw_diff*3},3000);


		$('#f2').css({"display": "block", "top":500*Math.random()+'px',"left":'0px'});
		$('#f2').animate({top:mid-mid_diff*4,left:vw-vw_diff*5},3000);


		$('#f3').css({"display": "block", "top":500*Math.random()+'px',"left":'0px'});
		$('#f3').animate({top:mid-mid_diff*4,left:vw-vw_diff*3},3000);

		$('#f4').css({"display": "block", "top":500*Math.random()+'px',"left":'0px'});
		$('#f4').animate({top:mid-mid_diff*4,left:vw-vw_diff*3},3000);
